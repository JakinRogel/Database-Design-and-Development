...
namespace DatabaseSQLMusicApp
{
    internal class AlbumsDAO
    {
        ...
        string connectionString =
            "datasource=localhost;port=3307;username=root;password=root;database=music2;";
        ...
        public List<Album> getAllAlbums()
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT ID, ALBUM_TITLE," +
                " ARTIST, YEAR, IMAGE_NAME, DESCRIPTION FROM ALBUMS", connection);
        ...
        public List<Album> searchTitles(String searchTerm)
        {
            ...
            command.CommandText = "SELECT ID, ALBUM_TITLE," +
                " ARTIST, YEAR, IMAGE_NAME, DESCRIPTION FROM ALBUMS" +
        ...
        internal int addOneAlbum(Album album)
        {
            ...
            //define the sql statement to fetch all aalbums
            MySqlCommand command = new MySqlCommand("INSERT INTO " +
                "`albums`( `ALBUM_TITLE`, `ARTIST`, `YEAR`, " +
                "`IMAGE_NAME`, `DESCRIPTION`) VALUES (@albumtitle," +
